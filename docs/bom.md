...
| Electric pipette | Sartorius Picus 2 (500–10,000 μL) | 2 | Dispensing speed electronically controlled in 9 steps, 1–10 mL/s |
...
| Web camera (appearance imaging) | Logitech C920n | 1 | Part of the imaging system |
| Light | NEEWER RGB62 | 1 | White/red/green/blue illumination |
| IoT sensor board | Raspberry Pi Zero WH + Waveshare Environment Sensor HAT | 1 | Temperature, humidity, acceleration, angular velocity, magnetic field |
